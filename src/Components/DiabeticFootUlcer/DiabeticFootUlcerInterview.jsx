...
const questions = [
  ...
  },
  {
    ...
    label: "زمان ابتلا به زخم پای دیابتی را در باکس زیر مشخص کنید : ",
    type: "text",
    validation: Yup.string(
      "لطفا زمان ابتلا به زخم پای دیابتی خود را با کیبورد انگلیسی و به درستی وارد کنید"
    ).required("لطفا زمان ابتلا به زخم پای دیابتی خود را وارد کنید"),
    placeholder: "مثلا : 2 ماه پیش",
  },
  {
    subLabel: "",
  ...
  },
  {
    ...
    type: "radio",
    options: [
      { id: "1", label: "در 6 ماه گذشته چنین عارضه ای نداشتم." },
      {
        id: "2",
        label: "بله ولی اذیت نشدم",
      },
      {
        id: "3",
        label: "خیلی کم",
